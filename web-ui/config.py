...
class Config:
    ...
    CAM1 = os.environ.get('CAM1', 'CAM1')
    CAM2 = os.environ.get('CAM2', 'CAM2')
    CAM3 = os.environ.get('CAM3', 'CAM3')
    CAM4 = os.environ.get('CAM4', 'CAM4')

    CAM1_NAME = os.environ.get('CAM1_NAME', 'Camera 1')
    CAM2_NAME = os.environ.get('CAM2_NAME', 'Camera 2')
    CAM3_NAME = os.environ.get('CAM3_NAME', 'Camera 3')
    CAM4_NAME = os.environ.get('CAM4_NAME', 'Camera 4')
